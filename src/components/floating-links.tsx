    ...
    <>
      ...
      <div className="fixed bottom-8 right-8 flex gap-3 z-[110]">
        ...
        >
          {theme === "dark" ? (
            <Sun
              className={`w-6 h-6 ${iconColorClass} group-hover:text-[#FACD00] transition-colors`}
            />
          ) : (
            <Moon
              className={`w-6 h-6 ${iconColorClass} group-hover:text-[#FACD00] transition-colors`}
      ...
      <div className="fixed bottom-8 left-8 flex gap-3 z-[110]">
        ...
        >
          <div
            className={`w-6 h-6 flex items-center justify-center font-black text-sm ${iconColorClass} group-hover:text-[#FACD00] transition-colors tracking-tighter`}
          >
            {language === "es" ? "EN" : "ES"}
          </div>
        </button>
